...
included_gk = knapSackEE(130, gk_start_cost_array, gk_points_array, len(gk_points_array), range(len(gk_points_array)),
                         gk_spaces)
included_df = knapSackEE(350, df_start_cost_array, df_points_array, len(df_points_array), range(len(df_points_array)),
                         df_spaces)
included_mf = knapSackEE(600, mf_start_cost_array, mf_points_array, len(mf_points_array), range(len(mf_points_array)),
                         mf_spaces)
included_fw = knapSackEE(350, fw_start_cost_array, fw_points_array, len(fw_points_array), range(len(fw_points_array)),
                         fw_spaces)
...
selected_gk = knapSackE(int(gks_final_cost), gk_start_cost_array, gk_points_array, len(gk_points_array),
                        range(len(gk_points_array)), gk_spaces)
selected_df = knapSackE(int(dfs_final_cost), df_start_cost_array, df_points_array, len(df_points_array),
                        range(len(df_points_array)), df_spaces)
selected_mf = knapSackE(int(mfs_final_cost), mf_start_cost_array, mf_points_array, len(mf_points_array),
                        range(len(mf_points_array)), mf_spaces)
selected_fw = knapSackE(int(fws_final_cost), fw_start_cost_array, fw_points_array, len(fw_points_array),
                        range(len(fw_points_array)), fw_spaces)
print(selected_gk)
print(selected_df)
print(selected_mf)
print(selected_fw)
